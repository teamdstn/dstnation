...
var arg = function(rgmt,sl){!sl&&(sl=0);for(var b=sl,d=(rgmt||[]).length,e=Array(d-sl);b<d;b++)e[b-sl]=rgmt[b];return e};
var args= function(arg,sht){ var rst=__g.arg(arg), clb; sht&&!rst[0] ? rst.shift() : define(rst,"first",{value:rst[0]}); clb=rst[rst.length-1]||rst[rst.length]; "function"===typeof clb&&(define(rst,"callback",{value:clb}),define(rst,"next",{value:clb}),define(rst,"cb",{value:clb}),rst.pop());rst.length&&define(rst,"last",{value:rst[rst.length-1]});return rst};
...
/* "statics" : {
  ...
  ━━━━━━━━━━━━━━━━━━━━━━━━━━*/
    ...
    var attr = args(arguments);
    var next = attr.cb;

		this.create(attr, function (err) {
      var _instance = args(arguments, true);
			if (err) {
