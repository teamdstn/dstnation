...
/* JStream
━━━━━━━━━━━━━━━━━━━━━━━━*/
function RStream(meta, single, dest) {
  Stream.call(this);
  this.response = dest;
  this.data=[];
  this.writable = true, this._single = single || [], this._done = false;
...
RStream.prototype.__proto__ = Stream.prototype;

RStream.prototype.write = function (doc) {
  this.data.push(doc);
  return true;
};

RStream.prototype.end = RStream.prototype.destroy = function () {
  if (this._done) return;
  var _x = this.response.locals.expose;
  _x.tmpl.o.rows = JSON.parse(JSON.stringify(this.data));
  _x.def.contents.push(_x.tmpl);

  console.log(_x.def.contents);
  delete _x.tmpl;
  this._done = true;
  return this.response.render("default.dtml");
...
module.exports.RStream            = RStream;
