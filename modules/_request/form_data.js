...
var parallel  = function(func,cb){var c="object"===typeof func?Object.keys(func).length:func.length,f={},g=!1,d={};c||cb(null,d);for(var b in func)(function(){var i=func[b],h=b;process.nextTick(function(){i(function(func,b){func&&(f[h]=func,g=!0);b&&(d[h]=b);c--;0==c&&cb(g?f:null,d)})})})()};
