var ElementType = require("./ElementType.js"), arrayPush = Array.prototype.push, DomUtils = module.exports;
...
DomUtils.getInnerHTML = function(elem) {
    ...
    var childs = elem.children, childNum = childs.length, ret = "";
...
DomUtils.getOuterHTML = function(elem) {
    var type = elem.type, name = elem.name;
