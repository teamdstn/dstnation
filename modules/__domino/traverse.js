var $u = require("./util"), select = require("./selector"), $ = require("../domino");
...
var parent = exports.parent = function(elem) {
    if (this[0] && this[0].parent) return $(this[0].parent); else return $();
};
...
var siblings = exports.siblings = function(elem) {
    if (!this[0]) return $();
    var self = this, siblings = this.parent() ? this.parent().children() : this.siblingsAndMe();
    siblings = $u.filter(siblings, function(elem) {
...
var children = exports.children = function(selector) {
    ...
    var children = $u.filter(this[0].children, function(elem) {
        return $.isTag(elem);
    });
    if (selector === undefined) return $(children); else if ($u.isNumber(selector)) return $(children[selector]);
