...
function pubsub(schema, options) {
  ...
  ;//====================================
  if (auto) {
    ["init", "save", "remove"].forEach(function (method) {
  ...
  ["method", "static"].forEach(function (key) {
  ...
  ["method", "static"].forEach(function (key) {
    schema[key]("getChannel", function () {
      ...
      if (!channel) {
        channel = this.prototype ? this.prototype.collection.name : this.constructor.collection.name;
      }
  ...
  ["subscribe", "unsubscribe"].forEach(function (method) {
    ["method", "static"].forEach(function (key) {
