...
var Plugin = require("../proto");
  ...
  sutil = require("util"),
  LessFactory = require("./less-factory");

var LessPlugin = function (options, app, name) {
    Plugin.apply(this, arguments);
    var dirPath = path.join(this.path, "less");
    if (!this.options.lessFactory) this.lessFactory = this.options.lessFactory = new LessFactory({
      paths: [dirPath]
    });
    this._variables = {};
  };
...
LessPlugin.prototype.routes = function () {
  ...
  app.post(base + "/admin", function (req, res, next) {
    ...
    lessFactory.createCache(function (err, obj) {
      ...
      if (install) lessFactory.checksum = obj.id;
