var Plugin = require('../proto'), util = require('util'), EditModel = require('./edit-display-model'), _u = require('underscore');
...
EditPlugin.prototype.routes = function () {
    ...
    this.app.all(this.pluginUrl + '*', function (req, res, next) {
        res.locals['editModel'] =  new EditModel(this.pluginManager.appModel, {
    ...
    this.app.get(this.baseUrl+'js/views/modeleditor/admin/:type/:view', function (req, res, next) {
        ...
        res.locals['model'] = editModel.modelPaths[req.params.type];
    ...
    this.app.get(base + '/admin', function (req, res) {
        ...
        var models = [];
        var editModel = res.locals['editModel'];
